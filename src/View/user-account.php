...
?>
                <form method="post">
                    ...
                    <table>
                        <tr>
                            <td><a href="<?php echo $url; ?>/uzytkownik,<?php echo $value['user_id']; ?>,edycja"><?php echo $value['user_name']; ?> <?php echo $value['user_surname']; ?></a></td>
                            <td class="option"><a href="<?php echo $url; ?>/uzytkownik,<?php echo $value['user_id']; ?>,edycja">Edytuj</a></td>
                        </tr>
                    </table>
...
?>
                        <tr>
                            <td><a href="<?php echo $url; ?>/strona,<?php echo $key; ?>,edycja"><?php echo $value['site_name']; ?></a></td>
                            <td class="option"><a href="<?php echo $url; ?>/strona,<?php echo $key; ?>,edycja">Edytuj</a></td>
                        </tr>
<?php
    }
