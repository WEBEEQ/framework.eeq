...
?>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Ulica:</td>
                            <td><input type="text" name="street" value="<?php echo stripslashes($array['street']); ?>" size="60" maxlength="60" /></td>
                        </tr>
                        <tr>
                            <td>Kod pocztowy:</td>
...
?>
                        ...
                        <tr>
                            <td>Telefon:</td>
                            <td><input type="text" name="phone" value="<?php echo stripslashes($array['phone']); ?>" size="20" maxlength="20" /></td>
                        </tr>
                        <tr>
                            <td>E-mail:</td>
